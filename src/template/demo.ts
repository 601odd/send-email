														...
														<tr>
															<td class="pad" style="padding-left:15px;padding-right:15px;padding-top:5px;">
																<div style="color:#555555;font-family:Tahoma,Verdana,Segoe,sans-serif;font-size:42px;line-height:120%;text-align:center;mso-line-height-alt:50.4px;">
																	<p style="margin: 0; word-break: break-word;"><span style="color:#23ad68;"><span><strong>Next.js + nodemailer + handlebars + bun ==> 发送定制化邮件</strong></span></span></p>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad" style="padding-bottom:5px;padding-left:15px;padding-right:15px;">
																<div style="color:#555555;font-family:Tahoma,Verdana,Segoe,sans-serif;font-size:20px;line-height:120%;text-align:center;mso-line-height-alt:24px;">
																	<p style="margin: 0; word-break: break-word;"><span style="color:#414042;"><span></span></span></p>
																</div>
															</td>
														</tr>
													</table>
